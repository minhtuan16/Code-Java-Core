...
public class DepartmentController {
	...
	@PostMapping("/create")
	public String create(@ModelAttribute Department department, Model model, @RequestParam("ngaytao") String date) throws ParseException {
...
//	2 cai tuong tu nhau
	...
	public String update(@ModelAttribute Department department) { // no map thang vao doi tuong Student va set thang gia tri vao id
														// va name
		departmentRepo.save(department);
